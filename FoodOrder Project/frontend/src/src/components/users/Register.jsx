...
const Register = () => {
  ...
  const submitHandler = (e) => {
    e.preventDefault(); //any chnages in form it renders and submit to prevent that we use this
    ...
    formData.set("name", name); //keyvalue pairs dict{"name":name}
    ...
    if (e.target.name === "avatar") {
      ...
      reader.onload = () => {
        ...
        if (reader.readyState === 2) {
          //send res to avatarPreview
          setAvatarPreview(reader.result);
          setAvatar(reader.result);
        }
      };
      //ensure reading started and read the first file
