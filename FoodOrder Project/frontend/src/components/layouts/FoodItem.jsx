...
export default function FoodItem({ fooditem, restaurant }) {
  ...
  const addToCartHandler = () => {
    //when u add items to cart without login, it routes back to login first
  ...
  return (
    <div className="col-sm-2 col-md-6 col-lg-3 my-3">
      <div className="card p-3 rounded">
        ...
        <div className="card-body d-flex flex-column">
          ...
          <p className="fooditems_des">{fooditem.description}</p>
